...
const adRecoveryBodyLines: string[] = [
  ...
  "Disaster Recovery, GPO Restore",
  "Object Fidelity",
  "Perfect - all attributes restored",
  "Partial - group memberships lost",
  "Downtime",
  "None",
  "Yes - DC must be in DSRM mode",
  "Complexity",
  "Low - single command/a few clicks",
  "High - multi-step, command-line process",
  "",
  "",
...
export const adRecovery: BlogPost = {
  ...
  headings: [
    ...
    { id: "authoritative-vs-non-authoritative-restore", text: "Authoritative vs. Non-Authoritative Restore", level: 3 },
